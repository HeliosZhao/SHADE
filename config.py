...
__C.DATASET.CITYSCAPES_DIR = '/ssd/yyzhao/data/CityScapes' 
#SDC Augmented Cityscapes Dir Location
__C.DATASET.CITYSCAPES_AUG_DIR = ''
#Mapillary Dataset Dir Location
__C.DATASET.MAPILLARY_DIR = '/ssd/yyzhao/data/mapillary' 
#GTAV, BDD100K Dataset Dir Location
__C.DATASET.GTAV_DIR = '/ssd/yyzhao/data/C-Driving/train/source'
__C.DATASET.BDD_DIR = '/ssd/yyzhao/data/bdd100k'
__C.DATASET.ACDC_DIR = '/ssd/yyzhao/data/ACDC' 
#Synthia Dataset Dir Location
__C.DATASET.SYNTHIA_DIR = '/ssd/yyzhao/data/synthia' 
